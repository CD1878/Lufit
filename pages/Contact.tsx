...
const Contact: React.FC<Props> = ({ onNavigate }) => {
    return (
        <div className="fade-in bg-gray-50 flex flex-col min-h-screen">
            {/* Header Section */}
            <div className="bg-anthracite text-white pt-12 pb-12 md:pt-24 md:pb-48 rounded-b-none md:rounded-b-[3rem] relative shadow-none md:shadow-xl overflow-hidden mb-0 md:mb-[-100px]">
                <div className="absolute top-0 left-0 w-full overflow-hidden leading-none opacity-10 rotate-180 hidden md:block">
            ...
            <div className="container mx-auto px-0 md:px-4 pb-12 md:py-16 relative z-10 flex-grow">
                <div className="bg-white rounded-none md:rounded-[3rem] shadow-none md:shadow-2xl overflow-hidden max-w-6xl mx-auto">
