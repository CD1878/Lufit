...
const Contact: React.FC<Props> = ({ onNavigate }) => {
    return (
        <div className="fade-in bg-gray-50 flex flex-col min-h-screen">
            {/* Header Section */}
            <div className="bg-anthracite text-white pt-12 pb-32 md:pt-24 md:pb-48 rounded-b-[3rem] relative shadow-xl overflow-hidden mb-[-50px] md:mb-[-100px]">
            ...
            <div className="container mx-auto px-4 py-12 md:py-16 relative z-10 flex-grow">
